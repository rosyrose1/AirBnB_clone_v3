#!/usr/bin/python3
'''Houses the places view for the API.'''
...
def handle_places(city_id=None, place_id=None):
    '''Function to handle requests to the places endpoint.
    '''
    handlers = {
        'GET': get_places,
        'DELETE': remove_place,
...
def get_places(city_id=None, place_id=None):
    '''Retrieves the place with the specified id or all places in
...
def remove_place(city_id=None, place_id=None):
    '''Deletes a place with the specified id.
    '''
    if place_id:
        place = storage.get(Place, place_id)
        if place:
...
def update_place(city_id=None, place_id=None):
    '''Modifies the place with the specified id.
    '''
