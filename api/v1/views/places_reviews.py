#!/usr/bin/python3
'''Encapsulates the places_reviews view for the API.'''
...
def handle_reviews(place_id=None, review_id=None):
    '''The function that deals with the reviews endpoint.
    '''
    handlers = {
        'GET': get_reviews,
...
def get_reviews(place_id=None, review_id=None):
    '''Retrieves the review with the given id or all reviews in
...
def update_review(place_id=None, review_id=None):
    '''Modifies the review with the given id.
    '''
